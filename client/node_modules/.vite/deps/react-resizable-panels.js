...
function Ve(e) {
  ...
  let r = false, a = false, c = -1, u = -1, g = 0, b, S = [];
  {
    let h = -1;
    for (const d of s)
...
var vt = /\b(?:position|zIndex|opacity|transform|webkitTransform|mixBlendMode|filter|webkitFilter|isolation)\b/;
function xt(e) {
...
var Ze = (0, import_react.createContext)(null);
function It(e, t) {
...
function Dt({
  ...
  }), m = ge(r), v = (0, import_react.useRef)(null), [x, y] = Gt(), p = (0, import_react.useRef)({
  ...
  }), (0, import_jsx_runtime.jsx)(Ze.Provider, { value: X, children: (0, import_jsx_runtime.jsx)(
    "div",
    {
      ...S,
      className: t,
...
function Vt({
  ...
  const i = t !== void 0, s = "id" in o ? o.id : o.groupId, l = fe(s, t ?? []), r = (0, import_react.useSyncExternalStore)(
    Ot,
    () => n.getItem(l),
    () => n.getItem(l)
    ...
    [r]
  ), c = (0, import_react.useRef)(null), u = (0, import_react.useCallback)(() => {
    const S = c.current;
  ...
  const g = (0, import_react.useCallback)(
    (S) => {
      u();
      let h;
...
function ve() {
  const e = (0, import_react.useContext)(Ze);
  return P(
    e,
...
function Tt(e, t) {
  const { id: n } = ve(), o = (0, import_react.useRef)({
    collapse: ce,
    expand: ce,
    getSize: () => ({
      asPercentage: 0,
...
function At({
  ...
  const h = !!r, d = ge(r), f = Se({
    disabled: s
  }), m = (0, import_react.useRef)(null), v = ye(m, l), {
    getPanelStyles: x,
    id: y,
    orientation: p,
    registerPanel: w,
  ...
  const V = (0, import_react.useSyncExternalStore)(
...
function Ft({
  ...
  const r = ge(i), a = Se({
    disabled: n
  }), [c, u] = (0, import_react.useState)({}), [g, b] = (0, import_react.useState)("inactive"), S = (0, import_react.useRef)(null), h = ye(S, o), {
    disableCursor: d,
    id: f,
    orientation: m,
    registerSeparator: v,
  ...
  }, [f, r, v, a]), (0, import_react.useEffect)(() => {
    x(r, !!n);
  }, [n, r, x]);
  let p;
  return n && !d && (p = "not-allowed"), (0, import_jsx_runtime.jsx)(
    "div",
    {
      ...l,
